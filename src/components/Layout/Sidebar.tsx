...
const navItems = [
  ...
  { path: '/seasons', label: 'Seasons & XP', icon: SeasonsIcon },
...
const gameShortcuts = [
  ...
  { path: '/games/meme-battle', label: 'Meme Battle', icon: TrophyIcon },
  { path: '/games/typing-arena', label: 'Typing Arena', icon: KeyboardIcon },
]

export function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-background-dark/80 backdrop-blur-xl border-r border-border flex flex-col">
      {/* Logo */}
      ...
      <nav className="flex-1 p-4 space-y-1">
        <div className="mb-4">
          <span className="text-xs font-medium text-text-muted uppercase tracking-wider px-3">
            Navigation
          </span>
        </div>
