#!/usr/bin/env bash
# Deploy Game of Life application to Conway testnet
# 
# Prerequisites:
...
echo "============================================"
echo "Game of Life Conway Deployment Script"
echo "============================================"
echo ""
...
echo "Building Game of Life WASM binaries..."
echo ""

cargo build --release --target wasm32-unknown-unknown -p game_of_life

# Check if build succeeded
CONTRACT_WASM="$CONTRACTS_DIR/target/wasm32-unknown-unknown/release/game_of_life_contract.wasm"
SERVICE_WASM="$CONTRACTS_DIR/target/wasm32-unknown-unknown/release/game_of_life_service.wasm"
...
# Game of Life doesn't need instantiation arguments
...
echo ""
echo "  export VITE_GOL_APP_ID=$APPLICATION_ID"
echo ""
echo "Or copy-paste into .env:"
echo "  VITE_GOL_APP_ID=$APPLICATION_ID"
echo ""
